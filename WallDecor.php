...
<body>
    ...
    <header>
        ...
        <nav id="nav">
            ...
            <a class="active" href="Walldecor.php">Wall Decor</a>
        ...
        <div class="pro-container">
            ...
            if (isset($url_components['query'])) {
                ...
                if (isset($params['search'])) {
                    ...
                    if ($params['search']) {
                        echo "<a href='WallDecor.php' class='normal Cart-Btn cart1'><i class='fa-solid fa-xmark'></i></a>";
                    }
                }
            }
            ...
            if (mysqli_num_rows($Select_Product) > 0) {
                while ($Fetch_Products = mysqli_fetch_assoc($Select_Product)) {
                    if ($Fetch_Products['Category_Name'] == "WallDecor") {
            ?>
                        <div class="pro">
