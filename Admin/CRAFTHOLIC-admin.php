    ...
    <section id="InterFace">
        ...
        <div class="Values">
            <div class="Val-Box">
                ...
                <div>
                    <?php
                    $select_Rows = mysqli_query($conn, "SELECT * FROM `registration`") or die("Query Failed");
                    $Row_Count = mysqli_num_rows($select_Rows);

                    ?>
                    <h3><?php echo $Row_Count; ?></h3>
                    <span><a href="#">Total Users</a></span>
                </div>
            </div>
            <div class="Val-Box">
                ...
                <div>
                    <?php
                    $select_Rows = mysqli_query($conn, "SELECT * FROM `shippingaddress`") or die("Query Failed");
                    $Row_Count = mysqli_num_rows($select_Rows);

                    ?>
                    <h3><?php echo $Row_Count; ?></h3>
                    <span><a href="../Admin/Admin-orders.php">Orders</a></span>
                </div>
            </div>
            <div class="Val-Box">
                ...
                <div>
                    ...
                    ?>
                    <h3><?php echo $Row_Count; ?></h3>
                    <span><a href="../Admin/Admin-AddProducts.php">Products</a> </span>
                </div>
            </div>
            <div class="Val-Box">
