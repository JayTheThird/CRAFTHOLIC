...
<head>
    ...
    <script src="JavaScript/Onclick_Function.js?v=<? $version ?>"></script>
...
<body>
    ...
    <header>
        ...
        <nav id="nav">
            ...
            <a class="active" href="homedecor.php">Home Decor</a>
    ...
    <section id="page-header">
        ...
        <h1><span>#</span>HomeDecor</h1>
        <p>“Decorating golden rule: Live with what you love.” <span>—Unknown</span></p>
        ...
        <div class="pro-container">
            ...
            if (isset($url_components['query'])) {
                ...
                if (isset($params['search'])) {
                    ...
                    if ($params['search'] != " ") {
                        echo "<a href='homedecor.php' class='normal Cart-Btn cart1'><i class='fa-solid fa-xmark'></i></a>";
                    }
                }
            }
            // New Query
            ...
            if (mysqli_num_rows($Select_Product) > 0) {
                while ($Fetch_Products = mysqli_fetch_assoc($Select_Product)) {
                    if ($Fetch_Products['Category_Name'] == "HomeDecor") {
            ?>
                        <div class="pro">
                            <form action="" method="post">
                                ...
                                <!-- For Add To Cart We Have TO use This hidden Feilds  -->
                                <button>
